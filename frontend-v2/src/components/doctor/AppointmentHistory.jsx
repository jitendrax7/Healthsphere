            ...
            >
              <div className="flex items-center gap-4 px-5 py-4 flex-wrap">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-white/80 truncate">{a.name || 'Patient'}</p>
                  <div className="flex flex-wrap items-center gap-3 mt-0.5 text-white/30 text-xs">
